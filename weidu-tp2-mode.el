...
;;Apparently Emacs does not do regexp-or for this?
(add-to-list 'auto-mode-alist '("\\.[Tt][Pp]2\\'" . weidu-tp2-mode))
(add-to-list 'auto-mode-alist '("\\.[Tt][Pp][Aa]\\'" . weidu-tp2-mode))
(add-to-list 'auto-mode-alist '("\\.[Tt][Pp][Pp]\\'" . weidu-tp2-mode))
(add-to-list 'auto-mode-alist '("\\.[Tt][Pp][Hh]\\'" . weidu-tp2-mode))
...
(defconst weidu-tp2-font-lock-keywords-1
  (list
   ...
   (cons weidu-tp2-values2 font-lock-variable-name-face)
