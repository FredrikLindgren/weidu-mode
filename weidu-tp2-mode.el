...
(add-to-list 'auto-mode-alist '("\\.[Tt][Pp]\(2\|[Aa]\|[Pp]\|[Hh]\)\\'" . weidu-tp2-mode)) ;this does not work

;PLUS_PLUS and MINUS_MINUS probably need to be treated separately
...
(defconst weidu-tp2-values2 "\<\([0-9]+\|0[Xx][0-9A-Fa-f]+\|0[Oo][0-7]+\|0[Bb][0-1]+\)\>")
