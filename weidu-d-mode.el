...
(defvar weidu-d-keywords (regexp-opt '("IF" "THEN" "BEGIN" "SAY" "END" "REPLY" "GOTO" "EXIT" "WEIGHT" "DO" "JOURNAL" "UNSOLVED_JOURNAL" "SOLVED_JOURNAL" "FLAGS" "EXTERN" "BRANCH" "AT" "UNLESS" "COPY_TRANS" "COPY_TRANS_LATE" "IF_FILE_EXISTS") 'words))
